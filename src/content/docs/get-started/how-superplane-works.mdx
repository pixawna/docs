...
import humanInLoop from "../../../assets/human_in_loop.png";
import screenshotBackground from "../../../assets/screenshot-background.png";
import superplaneWorkAsset from "../../../assets/superplane_work_asset.png";
import workflowPage from "../../../assets/workflow_page.png";
...
<figure class="sp-media-figure not-content">
  <Image src={superplaneWorkAsset} alt="SuperPlane coordinating agents through a software factory workflow" />
...
<figure class="sp-media-figure not-content">
  <Image src={workflowPage} alt="SuperPlane board with tasks in Backlog, Implement, Verify and Done" />
...
<figure class="sp-media-figure not-content">
  <Image src={screenshotBackground} alt="SuperPlane automation controls and execution details" />
...
<figure class="sp-media-figure not-content">
  <Image src={humanInLoop} alt="A person reviewing a decision in the SuperPlane workflow" />
