...
<CardGrid>
  ...
  />
  <LinkCard
    title="Learn how Superplane works"
    href="/get-started/how-superplane-works"
    description="Follow task intake, agent execution, verification and human review."
  />
  <LinkCard
    title="Video Walkthrough"
    href="/get-started/video-walkthrough"
    description="Watch a task move through planning, implementation, verification and review."
  />
  <LinkCard
...
<figure class="sp-media-figure not-content">
  <video aria-label="Introduction to the SuperPlane Factory workflow" controls playsinline preload="metadata" src="https://docs-assets.superplane.com/videos/introduction_demo.mp4">
  ...
  <Tabs>
    <TabItem label="Task">
      ...
      <figure class="sp-media-figure">
        <video aria-label="Creating a Factory task" controls playsinline preload="metadata" src="https://docs-assets.superplane.com/videos/Plan_section_video.mp4">
    ...
    <TabItem label="Plan">
      ...
      <figure class="sp-media-figure">
        <video aria-label="Assessing a task in the Backlog automation" controls playsinline preload="metadata" src="https://docs-assets.superplane.com/videos/plan_video.mp4">
          Your browser does not support embedded video.
        </video>
    ...
    <TabItem label="Implement">
      ...
      <figure class="sp-media-figure">
        <video aria-label="Implementing a task with a coding agent" controls playsinline preload="metadata" src="https://docs-assets.superplane.com/videos/implementation_video.mp4">
          Your browser does not support embedded video.
        </video>
    ...
    <TabItem label="Verify">
      ...
      <figure class="sp-media-figure">
        <video aria-label="Verifying an implemented task" controls playsinline preload="metadata" src="https://docs-assets.superplane.com/videos/verify_video.mp4">
          Your browser does not support embedded video.
        </video>
    ...
    <TabItem label="Review / Done">
      ...
      <figure class="sp-media-figure">
        <video aria-label="Reviewing a completed task" controls playsinline preload="metadata" src="https://docs-assets.superplane.com/videos/done_video.mp4">
          Your browser does not support embedded video.
        </video>
...
Read [Learn how Superplane works](/get-started/how-superplane-works) to learn how SuperPlane applies this model.
