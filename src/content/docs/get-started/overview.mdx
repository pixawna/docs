...
<figure class="sp-media-figure not-content">
  <video controls playsinline preload="metadata" src="https://docs-assets.superplane.com/videos/introduction_demo.mp4">
  ...
  <Tabs>
    <TabItem label="Task">
      ...
      <figure class="sp-media-figure">
        <video controls playsinline preload="metadata" src="https://docs-assets.superplane.com/videos/Plan_section_video.mp4">
    ...
    <TabItem label="Plan">
      ...
      <figure class="sp-media-figure">
        <video controls playsinline preload="metadata" src="https://docs-assets.superplane.com/videos/plan_video.mp4">
          Your browser does not support embedded video.
        </video>
    ...
    <TabItem label="Implement">
      ...
      <figure class="sp-media-figure">
        <video controls playsinline preload="metadata" src="https://docs-assets.superplane.com/videos/implementation_video.mp4">
          Your browser does not support embedded video.
        </video>
    ...
    <TabItem label="Verify">
      ...
      <figure class="sp-media-figure">
        <video controls playsinline preload="metadata" src="https://docs-assets.superplane.com/videos/verify_video.mp4">
          Your browser does not support embedded video.
        </video>
    ...
    <TabItem label="Review / Done">
      ...
      <figure class="sp-media-figure">
        <video controls playsinline preload="metadata" src="https://docs-assets.superplane.com/videos/done_video.mp4">
          Your browser does not support embedded video.
        </video>
