...
import introductionDemo from "../../../assets/introduction_demo.mp4";
import taskVideo from "../../../assets/Plan_section_video.mp4";
import planVideo from "../../../assets/plan_video.mp4";
import implementationVideo from "../../../assets/implementation_video.mp4";
import verifyVideo from "../../../assets/verify_video.mp4";
import doneVideo from "../../../assets/done_video.mp4";
...
<CardGrid>
  ...
  <LinkCard
    ...
    href="/get-started/overview/#video-walkthrough"
    description="A guided Factory walkthrough is coming soon."
  />
</CardGrid>
...
<figure class="sp-media-figure not-content">
  <video controls playsinline preload="metadata" src={introductionDemo}>
  ...
  <Tabs>
    <TabItem label="Task">
      ...
      <figure class="sp-media-figure">
        <video controls playsinline preload="metadata" src={taskVideo}>
    ...
    <TabItem label="Plan">
      ...
      <figure class="sp-media-figure">
        <video controls playsinline preload="metadata" src={planVideo}>
          Your browser does not support embedded video.
        </video>
    ...
    <TabItem label="Implement">
      ...
      <figure class="sp-media-figure">
        <video controls playsinline preload="metadata" src={implementationVideo}>
          Your browser does not support embedded video.
        </video>
    ...
    <TabItem label="Verify">
      ...
      <figure class="sp-media-figure">
        <video controls playsinline preload="metadata" src={verifyVideo}>
          Your browser does not support embedded video.
        </video>
    ...
    <TabItem label="Review / Done">
      ...
      <figure class="sp-media-figure">
        <video controls playsinline preload="metadata" src={doneVideo}>
          Your browser does not support embedded video.
        </video>
...
Read [How SuperPlane works](https://newdocs-livid.vercel.app/get-started/how-superplane-works) to learn how SuperPlane applies this model.
