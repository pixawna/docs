...
<figure class="sp-media-figure not-content">
  <video controls playsinline preload="metadata" src="https://assets.superplane.com/introduction_demo.mp4">
  ...
  <Tabs>
    <TabItem label="Task">
      ...
      <figure class="sp-media-figure">
        <video controls playsinline preload="metadata" src="https://assets.superplane.com/Plan_section_video.mp4">
    ...
    <TabItem label="Plan">
      ...
      <figure class="sp-media-figure">
        <video controls playsinline preload="metadata" src="https://assets.superplane.com/plan_video.mp4">
          Your browser does not support embedded video.
        </video>
    ...
    <TabItem label="Implement">
      ...
      <figure class="sp-media-figure">
        <video controls playsinline preload="metadata" src="https://assets.superplane.com/implementation_video.mp4">
          Your browser does not support embedded video.
        </video>
    ...
    <TabItem label="Verify">
      ...
      <figure class="sp-media-figure">
        <video controls playsinline preload="metadata" src="https://assets.superplane.com/verify_video.mp4">
          Your browser does not support embedded video.
        </video>
    ...
    <TabItem label="Review / Done">
      ...
      <figure class="sp-media-figure">
        <video controls playsinline preload="metadata" src="https://assets.superplane.com/done_video.mp4">
          Your browser does not support embedded video.
        </video>
