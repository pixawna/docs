...
<CardGrid>
  <LinkCard title="On Alert" href="#on-alert" description="Listen to alert created, acknowledged, closed, or deleted events in JSM Ops" />
  <LinkCard title="On Incident" href="#on-incident" description="Listen to incident created, updated, or deleted events in Jira Service Management" />
  <LinkCard title="On Issue" href="#on-issue" description="Listen to issue created, updated, or deleted events in Jira" />
  <LinkCard title="On Issue Comment" href="#on-issue-comment" description="Listen to comment created, updated, or deleted events on Jira issues" />
</CardGrid>
...
<CardGrid>
  ...
  <LinkCard title="Delete Alert" href="#delete-alert" description="Delete a Jira Service Management Ops alert by id" />
