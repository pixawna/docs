...
<CardGrid>
  ...
  <LinkCard title="CodePipeline • On Pipeline" href="#code-pipeline-•-on-pipeline" description="Listen to AWS CodePipeline pipeline execution state change events" />
  <LinkCard title="EC2 • On Alarm" href="#ec2-•-on-alarm" description="Listen to CloudWatch alarm state change events for a specific EC2 instance" />
...
<CardGrid>
  <LinkCard title="CloudWatch • Add Log Event" href="#cloud-watch-•-add-log-event" description="Write a log event to a CloudWatch Logs log stream" />
  ...
  <LinkCard title="CloudWatch • Delete Alarm" href="#cloud-watch-•-delete-alarm" description="Delete a CloudWatch metric alarm" />
  <LinkCard title="CloudWatch • Get Alarm" href="#cloud-watch-•-get-alarm" description="Read the configuration and current state of a CloudWatch metric alarm" />
  <LinkCard title="CloudWatch • Query Logs" href="#cloud-watch-•-query-logs" description="Run a CloudWatch Logs Insights query over one or more log groups and return structured rows" />
  ...
  <LinkCard title="EC2 • Create Instance" href="#ec2-•-create-instance" description="Launch a new EC2 instance and wait for it to reach running state" />
  <LinkCard title="EC2 • Create Load Balancer" href="#ec2-•-create-load-balancer" description="Create an Application, Network, or Gateway Load Balancer and wait for it to become active" />
  <LinkCard title="EC2 • Delete Instance" href="#ec2-•-delete-instance" description="Terminate an EC2 instance and wait for termination" />
  <LinkCard title="EC2 • Delete Load Balancer" href="#ec2-•-delete-load-balancer" description="Delete an Elastic Load Balancer and wait for deletion to complete" />
  ...
  <LinkCard title="Prometheus • Query" href="#prometheus-•-query" description="Execute a PromQL instant query against an Amazon Managed Service for Prometheus workspace" />
  <LinkCard title="Prometheus • Query Range" href="#prometheus-•-query-range" description="Execute a PromQL range query against an Amazon Managed Service for Prometheus workspace" />
  <LinkCard title="Prometheus • Update Rule Group Namespace" href="#prometheus-•-update-rule-group-namespace" description="Replace the rules document of a rule group namespace in an Amazon Managed Service for Prometheus workspace" />
...
```json
{
  "data": {
    ...
    "detail": {
      ...
      "execution-trigger": {
        "trigger-detail": "arn:aws:sts::123456789012:assumed-role/superplane-demo-role/SuperPlane-00000000-0000-0000-0000-000000000000",
        "trigger-type": "StartPipelineExecution"
      },
      "pipeline": "demo-pipeline",
      "pipeline-execution-attempt": 1,
      "start-time": "2026-02-24T15:21:42.016Z",
      "state": "STARTED",
      "version": 1
    },
    ...
    "time": "2026-02-24T15:21:42Z",
    "version": "0"
  },
  "timestamp": "2026-02-24T15:21:52.212Z",
  ...
  "data": {
    ...
    "detail": {
      ...
      "configuration": {
        ...
        "metrics": [
          {
            "id": "56cf46e9-e800-a52b-b55b-7f3c770c24ef",
            "metricStat": {
              "metric": {
                "dimensions": {
      ...
      "previousState": {
        "reason": "Threshold Crossed: 1 datapoint [0.3166666666666666 (03/06/26 14:15:00)] was not greater than the threshold (20.0).",
        "reasonData": "{\"version\":\"1.0\",\"queryDate\":\"2026-06-03T14:15:45.660+0000\",\"startDate\":\"2026-06-03T14:15:00.000+0000\",\"statistic\":\"Average\",\"period\":30,\"recentDatapoints\":[0.3166666666666666],\"threshold\":20.0,\"evaluatedDatapoints\":[{\"timestamp\":\"2026-06-03T14:15:00.000+0000\",\"sampleCount\":1.0,\"value\":0.3166666666666666}]}",
        "timestamp": "2026-06-03T14:15:45.663+0000",
        "value": "OK"
      },
      "state": {
        "reason": "Threshold Crossed: 1 datapoint [31.3283485070315 (03/06/26 15:45:00)] was greater than the threshold (20.0).",
        "reasonData": "{\"version\":\"1.0\",\"queryDate\":\"2026-06-03T15:46:15.660+0000\",\"startDate\":\"2026-06-03T15:45:00.000+0000\",\"statistic\":\"Average\",\"period\":30,\"recentDatapoints\":[31.3283485070315],\"threshold\":20.0,\"evaluatedDatapoints\":[{\"timestamp\":\"2026-06-03T15:45:00.000+0000\",\"sampleCount\":2.0,\"value\":31.3283485070315}]}",
        "timestamp": "2026-06-03T15:46:15.662+0000",
        "value": "ALARM"
      }
    },
    "detail-type": "CloudWatch Alarm State Change",
    "id": "ccc0350a-524d-2f57-068b-1cebb2a4b6c0",
    "region": "us-east-1",
    "resources": [
      "arn:aws:cloudwatch:us-east-1:123456789012:alarm:high cpu usage"
    ],
    "source": "aws.cloudwatch",
    "time": "2026-06-03T15:46:15Z",
    "version": "0"
  },
  "timestamp": "2026-06-03T15:46:16.233981639Z",
  "type": "aws.ec2.alarm"
}
```
...
<a id="cloud-watch-•-add-log-event"></a>

## CloudWatch • Add Log Event

**Component key:** `aws.cloudwatch.addLogEvent`

The Add Log Event component writes a single log event to a CloudWatch Logs log stream, creating the stream first if it doesn't exist yet.
...
```json
{
  "data": {
    ...
    "message": "Deployment approved by felix.gateru@example.com",
    "timestamp": "2026-05-29T09:00:00Z"
  },
  "timestamp": "2026-05-29T09:00:00.657831534Z",
  "type": "aws.cloudwatch.logEvent"
}
```

<a id="cloud-watch-•-create-alarm"></a>

## CloudWatch • Create Alarm

**Component key:** `aws.cloudwatch.createAlarm`

The Create Alarm component creates a CloudWatch metric alarm on any metric published to CloudWatch.
...
```json
{
  "data": {
    ...
    "alarmConfigurationUpdatedTimestamp": "2026-06-03T16:36:13.412Z",
    "alarmDescription": "API instances above 80% CPU",
    ...
    "stateUpdatedTimestamp": "2026-06-03T16:36:13.412Z",
...
<a id="cloud-watch-•-delete-alarm"></a>

## CloudWatch • Delete Alarm

**Component key:** `aws.cloudwatch.deleteAlarm`

The Delete Alarm component removes a CloudWatch metric alarm.
...
```json
{
  "data": {
    ...
    "alarmArn": "arn:aws:cloudwatch:us-east-1:123456789012:alarm:api-high-cpu",
    "alarmConfigurationUpdatedTimestamp": "2026-06-04T09:12:44.108Z",
    "alarmDescription": "API instances above 90% CPU",
    "alarmName": "api-high-cpu",
    "comparisonOperator": "GreaterThanThreshold",
    "datapointsToAlarm": 2,
    "deleted": true,
    ...
    "period": 300,
    "region": "us-east-1",
    "stateReason": "Threshold Crossed: 1 datapoint [72.4 (04/06/26 09:07:00)] was not greater than the threshold (90.0).",
    "stateReasonData": "{\"version\":\"1.0\",\"queryDate\":\"2026-06-04T09:12:44.101+0000\",\"statistic\":\"Average\",\"period\":300,\"recentDatapoints\":[72.4],\"threshold\":90.0}",
    "stateTransitionedTimestamp": "2026-06-04T09:12:44.108Z",
    "stateUpdatedTimestamp": "2026-06-04T09:12:44.108Z",
    "stateValue": "OK",
    "statistic": "Average",
    "threshold": 90,
    "thresholdMetricId": "",
  ...
  "timestamp": "2026-06-04T09:14:11.902154337Z",
  "type": "aws.cloudwatch.alarm.deleted"
}
```

<a id="cloud-watch-•-get-alarm"></a>

## CloudWatch • Get Alarm

**Component key:** `aws.cloudwatch.getAlarm`

The Get Alarm component describes a CloudWatch metric alarm and emits its current details.
...
```json
{
  "data": {
    ...
    "period": 300,
    "region": "us-east-1",
    "stateReason": "Threshold Crossed: 1 datapoint [95.8 (04/06/26 09:07:00)] was greater than the threshold (90.0).",
    "stateReasonData": "{\"version\":\"1.0\",\"queryDate\":\"2026-06-04T09:12:44.101+0000\",\"statistic\":\"Average\",\"period\":300,\"recentDatapoints\":[95.8],\"threshold\":90.0}",
    "stateTransitionedTimestamp": "2026-06-04T09:12:44.108Z",
    "stateUpdatedTimestamp": "2026-06-04T09:12:44.108Z",
    "stateValue": "ALARM",
    "statistic": "Average",
  ...
  "timestamp": "2026-06-04T09:13:02.774310588Z",
  "type": "aws.cloudwatch.alarm"
}
```

<a id="cloud-watch-•-query-logs"></a>

## CloudWatch • Query Logs

**Component key:** `aws.cloudwatch.queryLogs`

The Query Logs component runs a CloudWatch Logs Insights query over one or more log groups and returns the matching rows.
...
```json
{
  "data": {
    ...
    "rows": [
      {
        "@message": "START RequestId: 3f2a1c9e-1234-4a5b-8b9c-0d1e2f3a4b5c Version: $LATEST",
        "@timestamp": "2026-05-29 08:59:42.123"
      },
      {
        "@message": "END RequestId: 3f2a1c9e-1234-4a5b-8b9c-0d1e2f3a4b5c",
        "@timestamp": "2026-05-29 08:59:41.987"
      }
    ],
  ...
  "timestamp": "2026-05-29T09:00:01.123456Z",
  "type": "aws.cloudwatch.queryResult"
}
```

<a id="cloud-watch-•-update-alarm"></a>

## CloudWatch • Update Alarm

**Component key:** `aws.cloudwatch.updateAlarm`

The Update Alarm component modifies an existing CloudWatch metric alarm.
...
```json
{
  ...
  "timestamp": "2026-06-04T09:12:45.221408917Z",
  "type": "aws.cloudwatch.alarm"
}
```
...
```json
{
  ...
  "type": "aws.codeartifact.package.versions.copied"
}
```
...
```json
{
  ...
  "timestamp": "2026-03-26T19:29:35.841265352Z",
  "type": "aws.codeartifact.packageVersions"
}
```
...
<a id="code-pipeline-•-retry-stage-execution"></a>
...
```json
{
  "data": {
    "pipeline": {
      "name": "my-pipeline",
      "newExecutionId": "4444-5555-6666",
      "retryMode": "FAILED_ACTIONS",
      "sourceExecutionId": "1111-2222-3333",
      "stage": "Deploy"
    }
  },
  "timestamp": "2026-02-23T10:00:00.000000000Z",
  "type": "aws.codepipeline.stage.retry"
}
```
...
```json
{
  "data": {
    ...
    "tags": [
      {
        "key": "Name",
        "value": "ephemeral-builder"
      },
      {
        "key": "purpose",
        "value": "release-canary"
      }
    ],
...
<a id="ec2-•-create-load-balancer"></a>

## EC2 • Create Load Balancer

**Component key:** `aws.ec2.createLoadBalancer`

The Create Load Balancer component provisions an Elastic Load Balancer (ELBv2) and waits until it reaches **active** state before emitting.
...
```json
{
  ...
  "type": "aws.ec2.instance.deleted"
}
```

<a id="ec2-•-delete-load-balancer"></a>

## EC2 • Delete Load Balancer

**Component key:** `aws.ec2.deleteLoadBalancer`

The Delete Load Balancer component deletes an Elastic Load Balancer (ELBv2) and waits until AWS confirms deletion.
...
```json
{
  ...
  "timestamp": "2026-05-21T12:05:00Z",
  "type": "aws.ec2.loadBalancer.deleted"
}
```
...
<a id="ec2-•-get-instance-metrics"></a>

## EC2 • Get Instance Metrics

**Component key:** `aws.ec2.getInstanceMetrics`
...
```json
{
  "data": {
    ...
    "avgNetworkInBytesPerSec": 107.25,
    "avgNetworkOutBytesPerSec": 11.63,
    "end": "2026-05-29T08:50:49Z",
    "instanceId": "i-0abc1234567890def",
    "lookbackPeriod": "7d",
    "region": "eu-north-1",
    "start": "2026-05-22T08:50:49Z",
    "totalNetworkInBytes": 64866070,
    "totalNetworkOutBytes": 7032351
  },
  "timestamp": "2026-05-29T08:50:50.657831534Z",
  "type": "aws.ec2.instance.metrics"
}
```
...
**Component key:** `aws.ec2.updateInstance`
...
```json
{
  "data": {
    "imageId": "ami-0215d085326c25744",
    "instanceId": "i-03976dc68f19ba526",
    "instanceType": "t3.micro",
    "keyName": "my-key",
    "launchTime": "2026-05-29T08:52:02.000Z",
    "name": "ephemeral-builder",
    "privateDnsName": "ip-10-0-1-25.ec2.internal",
    "privateIpAddress": "10.0.1.25",
    "publicDnsName": "ec2-54-198-10-42.compute-1.amazonaws.com",
  ...
  "timestamp": "2026-05-29T08:52:13.71956816Z",
  "type": "aws.ec2.instance.updated"
}
```
...
The Create Rule Group Namespace component creates a new rule group namespace in an Amazon Managed Service for Prometheus workspace, uploading a YAML document with one or more Prometheus alerting or recording rule groups.

### Configuration

- **Region**: AWS region of the workspace
- **Workspace**: Target workspace
- **Name**: Name for the new rule group namespace
- **Rules Document (YAML)**: YAML document containing one or more rule groups
- **Client Token**: Optional idempotency token
- **Tags**: Optional namespace tags
...
```json
{
  "data": {
    "namespace": {
      "arn": "arn:aws:aps:us-east-1:123456789012:rulegroupsnamespace/ws-22222222-2222-4222-8222-222222222222/example-alerts",
      "name": "example-alerts",
      "status": {
        "statusCode": "CREATING"
      },
    ...
    "workspaceId": "ws-22222222-2222-4222-8222-222222222222"
  },
  "timestamp": "2026-01-01T00:10:00.000000000Z",
...
**Component key:** `aws.prometheus.createWorkspace`
...
```json
{
  "data": {
    "workspace": {
      "alias": "example-workspace-created",
      "arn": "arn:aws:aps:us-east-1:123456789012:workspace/ws-22222222-2222-4222-8222-222222222222",
      "status": {
        "statusCode": "CREATING"
      },
      "tags": {
...
The Delete Rule Group Namespace component permanently removes a rule group namespace and all its associated alerting and recording rules from an Amazon Managed Service for Prometheus workspace.
...
```json
{
  "data": {
    ...
    "workspaceId": "ws-11111111-1111-4111-8111-111111111111"
  },
  "timestamp": "2026-01-01T00:20:00.000000000Z",
...
**Component key:** `aws.prometheus.deleteWorkspace`
...
The Get Rule Group Namespace component retrieves the configuration and current status of a rule group namespace, including its rules document and creation timestamp.
...
```json
{
  "data": {
    "namespace": {
      "arn": "arn:aws:aps:us-east-1:123456789012:rulegroupsnamespace/ws-11111111-1111-4111-8111-111111111111/example-alerts",
...
<a id="prometheus-•-get-workspace"></a>

## Prometheus • Get Workspace

**Component key:** `aws.prometheus.getWorkspace`
...
```json
{
  "data": {
    "workspace": {
      ...
      "arn": "arn:aws:aps:us-east-1:123456789012:workspace/ws-11111111-1111-4111-8111-111111111111",
      "createdAt": "2026-01-01T00:00:00Z",
      "prometheusEndpoint": "https://aps-workspaces.us-east-1.amazonaws.com/workspaces/ws-11111111-1111-4111-8111-111111111111/",
      "status": {
        "statusCode": "ACTIVE"
      },
      "tags": {
...
<a id="prometheus-•-query"></a>

## Prometheus • Query

**Component key:** `aws.prometheus.query`

The Query component executes an instant PromQL query against an Amazon Managed Service for Prometheus workspace.
...
```json
{
  "data": {
    "result": [
      ...
      {
        "metric": {
          "component": "run_promql_range_query",
          "instance": "host.docker.internal:8000"
        },
        "value": [
          1781107045,
  ...
  "timestamp": "2026-01-01T00:05:00.000000000Z",
  "type": "aws.prometheus.query"
}
```

<a id="prometheus-•-query-range"></a>

## Prometheus • Query Range

**Component key:** `aws.prometheus.queryRange`

The Query Range component executes a range PromQL query against an Amazon Managed Service for Prometheus workspace.
...
```json
{
  ...
  "timestamp": "2026-01-01T00:05:00.000000000Z",
  "type": "aws.prometheus.queryRange"
}
```
...
The Update Rule Group Namespace component replaces the rules document of an existing rule group namespace with a new YAML definition. This is a full replacement — the entire rules document is overwritten.
...
<a id="prometheus-•-update-workspace"></a>

## Prometheus • Update Workspace

**Component key:** `aws.prometheus.updateWorkspace`
...
{
  "data": {
    "alias": "example-workspace-updated",
    "updated": true,
    "workspaceId": "ws-22222222-2222-4222-8222-222222222222"
  },
  "timestamp": "2026-01-01T00:20:00.000000000Z",
  "type": "aws.prometheus.workspace.updated"
}
```
