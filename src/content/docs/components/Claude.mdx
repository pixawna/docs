...
<CardGrid>
  ...
  <LinkCard title="Run Managed Agent" href="#run-managed-agent" description="Runs a Claude Managed Agent in Anthropic’s managed environment and waits until the session is idle or terminated." />
    ...
    "artifacts": [
      {
        ...
        "encoding": "text",
        "fileId": "file_011CNha8iCJcU1wXNR6q4V8w",
        "filename": "deployment-summary.csv",
        "mimeType": "text/csv",
        "sizeBytes": 2048
      }
    ],
