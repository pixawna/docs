...
- Group membership can add additional roles. Effective permissions are the union of direct, group and inherited roles.
...
| Maintainer | Operator | Manage members, groups, roles, canvases, integrations, secrets and API keys. |
...
Owner is a flag on the organization membership. It is not a role or part of the inheritance chain. The Members page shows it as a badge.
...
Permissions are defined as resource/action pairs (for example, `members.create`). Use this list when building custom roles.
...
![Roles page](https://docs-assets.superplane.com/images/rbac-roles.png)

The Create Role page lets you pick permissions by category.

![Create role page](https://docs-assets.superplane.com/images/rbac-create-role.png)
...
![Groups page](https://docs-assets.superplane.com/images/rbac-groups.png)
![Groups creation page](https://docs-assets.superplane.com/images/rbac-create-group.png)
...
![Members page](https://docs-assets.superplane.com/images/rbac-members.png)
