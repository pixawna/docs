...
import demoIssue from "../../../assets/demo_issue_1.png";
import githubIssue from "../../../assets/github_issue.png";
import issueFlow from "../../../assets/issue_flow.png";
import backlogCheck from "../../../assets/backlog_check.png";
import implementCheck from "../../../assets/implement_check.png";
import workInCheck from "../../../assets/work_in_check.png";
import reviewSection from "../../../assets/review_section.png";
import pullRequest from "../../../assets/pull_request_1.png";
import completeDone from "../../../assets/complete_done.png";
import finalWeb from "../../../assets/final_web.png";
...
<figure class="sp-media-figure not-content">
  <Image src={demoIssue} alt="Flow for taking a small improvement from GitHub through SuperPlane implementation and verification" />
...
<figure class="sp-media-figure not-content">
  <Image src={githubIssue} alt="GitHub issue 5 requesting a light and dark theme toggle for the Factory Starter App" />
...
<figure class="sp-media-figure not-content">
  <Image src={issueFlow} alt="Issue 5 moving from GitHub through backlog, analysis, implementation and verification" />
...
<figure class="sp-media-figure not-content">
  <Image src={backlogCheck} alt="Theme toggle issue in the Backlog stage with a high confidence indicator" />
...
<figure class="sp-media-figure not-content">
  <Image src={implementCheck} alt="Theme toggle task running in the Implement stage" />
  <figcaption>The factory board shows the task moving from Backlog into Implement.</figcaption>
</figure>

<figure class="sp-media-figure not-content">
  <Image src={workInCheck} alt="Implementation agent inspecting the Factory Starter App and working on the theme toggle" />
...
<figure class="sp-media-figure not-content">
  <Image src={reviewSection} alt="SuperPlane task ready for pull request review after verification" />
...
<figure class="sp-media-figure not-content">
  <Image src={pullRequest} alt="GitHub pull request for the Factory Starter App theme toggle" />
...
<figure class="sp-media-figure not-content">
  <Image src={completeDone} alt="Merged theme toggle task in the Done stage" />
...
<a href="https://factoryapp-ashen.vercel.app/" target="_blank" rel="noreferrer">
  <figure class="sp-media-figure not-content">
    <Image src={finalWeb} alt="Factory Starter App with the completed theme toggle in its header" />
