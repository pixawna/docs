...
<figure class="sp-media-figure not-content">
  <img src="https://assets.superplane.com/src/assets/demo_issue_1.png" alt="Flow for taking a small improvement from GitHub through SuperPlane implementation and verification" />
...
<figure class="sp-media-figure not-content">
  <img src="https://assets.superplane.com/src/assets/github_issue.png" alt="GitHub issue 5 requesting a light and dark theme toggle for the Factory Starter App" />
...
<figure class="sp-media-figure not-content">
  <img src="https://assets.superplane.com/src/assets/issue_flow.png" alt="Issue 5 moving from GitHub through backlog, analysis, implementation and verification" />
...
<figure class="sp-media-figure not-content">
  <img src="https://assets.superplane.com/src/assets/backlog_check.png" alt="Theme toggle issue in the Backlog stage with a high confidence indicator" />
...
<figure class="sp-media-figure not-content">
  <img src="https://assets.superplane.com/src/assets/implement_check.png" alt="Theme toggle task running in the Implement stage" />
  <figcaption>The factory board shows the task moving from Backlog into Implement.</figcaption>
</figure>

<figure class="sp-media-figure not-content">
  <img src="https://assets.superplane.com/src/assets/work_in_check.png" alt="Implementation agent inspecting the Factory Starter App and working on the theme toggle" />
...
<figure class="sp-media-figure not-content">
  <img src="https://assets.superplane.com/src/assets/review_section.png" alt="SuperPlane task ready for pull request review after verification" />
...
<figure class="sp-media-figure not-content">
  <img src="https://assets.superplane.com/src/assets/pull_request_1.png" alt="GitHub pull request for the Factory Starter App theme toggle" />
...
<figure class="sp-media-figure not-content">
  <img src="https://assets.superplane.com/src/assets/complete_done.png" alt="Merged theme toggle task in the Done stage" />
...
<a href="https://factoryapp-ashen.vercel.app/" target="_blank" rel="noreferrer">
  <figure class="sp-media-figure not-content">
    <img src="https://assets.superplane.com/src/assets/final_web.png" alt="Factory Starter App with the completed theme toggle in its header" />
