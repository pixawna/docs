...
<figure class="sp-media-figure not-content">
  <img src="https://docs-assets.superplane.com/images/performance-task-time.png" alt="The Task time view showing median cycle time, time running and time in waiting across the selected period." />
