...
import taskTime from "../../../assets/performance-task-time.png";
...
<figure class="sp-media-figure not-content">
  <Image src={taskTime} alt="The Task time view showing median cycle time, time running and time in waiting across the selected period." />
