...
import verifyBoard from "../../../assets/verify_phase.png";
import reviewDetail from "../../../assets/review_section.png";
...
<figure class="sp-media-figure not-content">
  <Image src={verifyBoard} alt="A Factory board with a task in Verify and its pull request attached for review." />
...
<figure class="sp-media-figure not-content">
  <Image src={reviewDetail} alt="A SuperPlane task review panel showing the task details and attached pull request for a human decision." />
