...
<figure class="sp-media-figure not-content">
  <img src="https://assets.superplane.com/src/assets/verify_phase.png" alt="A Factory board with a task in Verify and its pull request attached for review." />
...
<figure class="sp-media-figure not-content">
  <img src="https://assets.superplane.com/src/assets/review_section.png" alt="A SuperPlane task review panel showing the task details and attached pull request for a human decision." />
