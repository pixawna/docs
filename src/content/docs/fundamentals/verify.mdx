...
<figure class="sp-media-figure not-content">
  <img src="https://docs-assets.superplane.com/images/verify_phase_issue_1.webp" alt="A Factory board with a task in Verify and its pull request attached for review." />
...
<figure class="sp-media-figure not-content">
  <img src="https://docs-assets.superplane.com/images/when_to_ask_human.webp" alt="A SuperPlane task review panel showing the task details and attached pull request for a human decision." />
