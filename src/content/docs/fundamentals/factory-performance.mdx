...
<figure class="sp-media-figure not-content">
  <img src="https://docs-assets.superplane.com/images/factory_performance.webp" alt="The SuperPlane Velocity view showing tasks closed, task waste, median cycle time, cost per task and merged pull requests." />
