...
import performanceOverview from "../../../assets/performance-overview.png";
...
<figure class="sp-media-figure not-content">
  <Image src={performanceOverview} alt="The SuperPlane Velocity view showing tasks closed, task waste, median cycle time, cost per task and merged pull requests." />
