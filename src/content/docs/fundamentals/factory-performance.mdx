...
<figure class="sp-media-figure not-content">
  <img src="https://assets.superplane.com/src/assets/performance-overview.png" alt="The SuperPlane Velocity view showing tasks closed, task waste, median cycle time, cost per task and merged pull requests." />
