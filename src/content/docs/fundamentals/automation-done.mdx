...
<figure class="sp-media-figure not-content">
  <img src="https://docs-assets.superplane.com/images/complete_done.png" alt="A SuperPlane Factory board with completed and merged tasks recorded in the Done column." />
