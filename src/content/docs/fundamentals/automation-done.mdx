...
<figure class="sp-media-figure not-content">
  <img src="https://assets.superplane.com/src/assets/complete_done.png" alt="A SuperPlane Factory board with completed and merged tasks recorded in the Done column." />
