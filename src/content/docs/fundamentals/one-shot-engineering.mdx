...
import superplaneWork from "../../../assets/superplane_work_asset.png";
import factoryLoop from "../../../assets/software_factory_exp.png";
import initialCheck from "../../../assets/initial_check.png";
import automationWorkflow from "../../../assets/screenshot-background.png";
...
<figure class="sp-media-figure not-content">
  <Image src={superplaneWork} alt="SuperPlane moving work from issue discovery through implementation, verification and human approval" />
...
<figure class="sp-media-figure sp-media-figure--compact not-content">
  <Image src={factoryLoop} alt="Software factory loop with human review at planning, implementation and final review" />
...
<figure class="sp-media-figure not-content">
  <Image src={automationWorkflow} alt="SuperPlane implementation automation with agent execution, failure handling and task artifacts" />
...
<figure class="sp-media-figure not-content">
  <Image src={verifyPhase} alt="A pull request task waiting in the Verify stage of a SuperPlane factory" />
...
<figure class="sp-media-figure not-content">
  <Image src={initialCheck} alt="One-shot engineering flow with retry and human attention paths" />
...
<figure class="sp-media-figure not-content">
  <Image src={humanInLoop} alt="Agent workflow pausing for human judgment before continuing" />
