...
<figure class="sp-media-figure not-content">
  <img src="https://docs-assets.superplane.com/images/automation-backlog.png" alt="A Backlog automation with an On Task trigger, a SuperPlane agent, failure recording, an artifact and a confidence check." />
