...
<figure class="sp-media-figure not-content">
  <img src="https://assets.superplane.com/src/assets/automation-backlog.png" alt="A Backlog automation with an On Task trigger, a SuperPlane agent, failure recording, an artifact and a confidence check." />
