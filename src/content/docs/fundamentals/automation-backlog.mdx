...
import backlogAutomation from "../../../assets/automation-backlog.png";
...
<figure class="sp-media-figure not-content">
  <Image src={backlogAutomation} alt="A Backlog automation with an On Task trigger, a SuperPlane agent, failure recording, an artifact and a confidence check." />
