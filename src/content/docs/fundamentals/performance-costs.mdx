...
<figure class="sp-media-figure not-content">
  <img src="https://docs-assets.superplane.com/images/performance-costs.png" alt="The Factory Costs view showing total cost split between model tokens and compute across the reporting period." />
