...
<figure class="sp-media-figure not-content">
  <img src="https://docs-assets.superplane.com/images/factory_performance_cost.webp" alt="The Factory Costs view showing total cost split between model tokens and compute across the reporting period." />
...
<figure class="sp-media-figure not-content">
  <img src="https://docs-assets.superplane.com/images/performance-per-task-costs.png" alt="The Per task costs chart showing median token and compute spend for tasks closed each day." />
