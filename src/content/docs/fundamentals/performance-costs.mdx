...
import totalCosts from "../../../assets/performance-costs.png";
import perTaskCosts from "../../../assets/performance-per-task-costs.png";
...
<figure class="sp-media-figure not-content">
  <Image src={totalCosts} alt="The Factory Costs view showing total cost split between model tokens and compute across the reporting period." />
...
<figure class="sp-media-figure not-content">
  <Image src={perTaskCosts} alt="The Per task costs chart showing median token and compute spend for tasks closed each day." />
