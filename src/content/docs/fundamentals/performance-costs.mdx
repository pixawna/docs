...
<figure class="sp-media-figure not-content">
  <img src="https://assets.superplane.com/src/assets/performance-costs.png" alt="The Factory Costs view showing total cost split between model tokens and compute across the reporting period." />
...
<figure class="sp-media-figure not-content">
  <img src="https://assets.superplane.com/src/assets/performance-per-task-costs.png" alt="The Per task costs chart showing median token and compute spend for tasks closed each day." />
