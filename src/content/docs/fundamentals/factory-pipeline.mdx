...
<figure class="sp-media-figure not-content">
  <img src="https://docs-assets.superplane.com/images/verify_phase_issue_1.webp" alt="A SuperPlane task moving from connected work sources through discovery, implementation, verification and completion, with paths for retries and human decisions." />
...
<figure class="sp-media-figure not-content">
  <img src="https://docs-assets.superplane.com/images/final_done.png" alt="A SuperPlane Factory board with Backlog, Implement, Verify and Done columns and completed tasks recorded in Done." />
