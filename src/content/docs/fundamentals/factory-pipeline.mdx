...
<figure class="sp-media-figure not-content">
  <img src="https://assets.superplane.com/src/assets/superplane_work_asset.png" alt="A SuperPlane task moving from connected work sources through discovery, implementation, verification and completion, with paths for retries and human decisions." />
...
<figure class="sp-media-figure not-content">
  <img src="https://assets.superplane.com/src/assets/final_done.png" alt="A SuperPlane Factory board with Backlog, Implement, Verify and Done columns and completed tasks recorded in Done." />
