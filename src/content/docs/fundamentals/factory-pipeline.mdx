...
<figure class="sp-media-figure not-content">
  <img src="https://docs-assets.superplane.com/images/superplane_work_asset.png" alt="A SuperPlane task moving from connected work sources through discovery, implementation, verification and completion, with paths for retries and human decisions." />
