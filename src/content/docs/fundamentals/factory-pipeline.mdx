...
import pipelineOverview from "../../../assets/superplane_work_asset.png";
import factoryBoard from "../../../assets/final_done.png";
...
<figure class="sp-media-figure not-content">
  <Image src={pipelineOverview} alt="A SuperPlane task moving from connected work sources through discovery, implementation, verification and completion, with paths for retries and human decisions." />
...
<figure class="sp-media-figure not-content">
  <Image src={factoryBoard} alt="A SuperPlane Factory board with Backlog, Implement, Verify and Done columns and completed tasks recorded in Done." />
