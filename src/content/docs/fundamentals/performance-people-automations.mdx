...
import performanceBreakdown from "../../../assets/performance-breakdown.png";
...
<figure class="sp-media-figure not-content">
  <Image src={performanceBreakdown} alt="Factory performance tables showing member activity and automation runs, failures, duration and cost." />
