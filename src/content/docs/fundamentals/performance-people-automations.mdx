...
<figure class="sp-media-figure not-content">
  <img src="https://docs-assets.superplane.com/images/performance-breakdown.png" alt="Factory performance tables showing member activity and automation runs, failures, duration and cost." />
