...
<figure class="sp-media-figure not-content">
  <img src="https://docs-assets.superplane.com/images/agent_config.png" alt="A SuperPlane board with one task moving from Backlog into the Implement stage." />
...
<figure class="sp-media-figure not-content">
  <img src="https://docs-assets.superplane.com/images/implementation_phase.png" alt="The Implement automation with a running agent and a workflow graph for creating or updating a pull request." />
