...
import implementBoard from "../../../assets/agent_config.png";
import implementRun from "../../../assets/implementation_phase.png";
...
<figure class="sp-media-figure not-content">
  <Image src={implementBoard} alt="A SuperPlane board with one task moving from Backlog into the Implement stage." />
...
<figure class="sp-media-figure not-content">
  <Image src={implementRun} alt="The Implement automation with a running agent and a workflow graph for creating or updating a pull request." />
