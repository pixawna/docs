...
<figure class="sp-media-figure not-content">
  <img src="https://docs-assets.superplane.com/images/factory_board.png" alt="SuperPlane importing and scoring two GitHub issues before opening the Factory board." />
...
<figure class="sp-media-figure not-content">
  <img src="https://docs-assets.superplane.com/images/main_screenshot.webp" alt="A Factory board showing discovered tasks in Backlog with readiness indicators and a Start action." />
