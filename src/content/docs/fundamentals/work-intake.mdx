...
<figure class="sp-media-figure not-content">
  <img src="https://docs-assets.superplane.com/images/main_screenshot.png" alt="A Factory board showing discovered tasks in Backlog with readiness indicators and a Start action." />
