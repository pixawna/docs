...
import intakeScreen from "../../../assets/factory_board.png";
import backlogBoard from "../../../assets/main_screenshot.png";
...
<figure class="sp-media-figure not-content">
  <Image src={intakeScreen} alt="SuperPlane importing and scoring two GitHub issues before opening the Factory board." />
...
<figure class="sp-media-figure not-content">
  <Image src={backlogBoard} alt="A Factory board showing discovered tasks in Backlog with readiness indicators and a Start action." />
