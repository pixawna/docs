...
<div class="big-image">
  <figure class="sp-canvas-figure">
    <img
      src="https://docs-assets.superplane.com/previous/src/assets/console-overview.png"
...
Changes follow the same **stage and commit** flow as the canvas: edits stay in staging until you commit them. See [Files](/concepts/files) for the underlying YAML
