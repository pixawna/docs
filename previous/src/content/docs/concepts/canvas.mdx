...
<div class="big-image">
  <figure class="sp-canvas-figure">
    <img
      src="https://assets.superplane.com/previous/src/assets/canvas-overview.png"
...
![Inspecting a node payload](https://assets.superplane.com/previous/src/assets/canvas-overview-payload.png)

When configuring nodes, type `{{` in expression fields to access payload data from upstream nodes.

![Selecting payload data in expressions](https://assets.superplane.com/previous/src/assets/canvas-overview-selecting-payload.png)
