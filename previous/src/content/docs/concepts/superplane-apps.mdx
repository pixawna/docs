...
<div class="big-image">
  <figure class="sp-canvas-figure">
    <img src="https://docs-assets.superplane.com/previous/src/assets/app-overview-canvas.png" alt="" />
  </figure>
</div>
...
- **[Agent](/concepts/agent)** — A built-in AI assistant that helps you design workflows, make canvas changes, and troubleshoot failed executions.
...
5. **Everything is versioned**: The entire configuration of the **Canvas** and **Console** is saved in the **Files** repository, allowing you to stage, commit, and review changes safely.
